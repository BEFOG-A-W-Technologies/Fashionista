            ...
            <div>
                ...
                <div className="mt-8">
                    <div className="w-[480px] h-[50px] border-2 border-slate-400 rounded-md flex justify-between items-center bg-white">
                        {/* Received Button */}
                        <button
                            className={`w-1/2 h-full ${activeTab === 'received' ? 'bg-[#A45286] text-white' : 'bg-[#c88bb2] text-white'} font-semibold hover:bg-[#A45286] transition-all duration-200 rounded-l-md`}
                        ...
                        {/* Sent Button */}
                        <button
                            className={`w-1/2 h-full ${activeTab === 'sent' ? 'bg-[#A45286] text-white' : 'bg-[#c88bb2] text-white'} font-semibold hover:bg-[#A45286]  transition-all duration-200 rounded-r-md`}
                            onClick={handleSent}
                        >
                            Sent
                        </button>
